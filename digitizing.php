        ...
        <div class="row">
            <div class="col-lg-6 about-right-faq">
                ...
                <p class="mt-4">We have professional and experienced embroidery digitizers for converting your designs
                    into the digitized embroidery file format of your choice.
                </p>
                <ul class="w3l-right-book mt-4">
                    <li>3D / Puff Embroidery Digitizing</li>
                    <li>Chenille Embroidery Digitizing</li>
                    <li>Sequin Embroidery Digitizing</li>
                    <li>Applique Embroidery Digitizing</li>
