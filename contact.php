        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="contu">
                    ...
                    <!-- Links -->
                    <h6 class="text-uppercase fw-bold text-primary mb-4 text-left mt-4"
                        style="color: #705ecf !important;">
                        Contact</h6>

                    <h5 style="font-family:poppins;" class="text-left text-dark mb-2"><i
                            class="fa fa-phone-square mr-3 "></i> +1-347-474-0030
                    </h5>

                    <h5 style="font-size: 1.2rem; font-family:poppins; margin-top:2rem;"
                        class="text-left  text-dark mb-4  "><i class="fa fa-envelope-o  mll"></i>
                        info@digipatchsolutions.com
                    </h5>
                    <h5 style="font-size: 1.2rem; font-family:poppins;" class=" text-left text-dark mb-4
                        mt-4 "><i class=" fa fa-envelope-o mll"></i>
                        sales@digipatchsolutions.com
                    </h5>


                    <h6 class="text-uppercase fw-bold text-primary mb-4  text-left mtt"
                        style="color: #705ecf !important;">Based in</h6>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="text" placeholder="Eg: John Smith"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="text" placeholder="+1-234-567-7890"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea placeholder="Add your Message here" value="<?php echo $message; ?>"
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <button type="submit" name="contact-form"
                                    class="btn btn-cont-w3 btn-block mt-4">Send</button>
