    ...
    <div class="container pb-xl-5 pb-lg-3">
        <div class="row py-xl-4">
            <div class="col-lg-5 about-right-faq pr-5">
                <h6>OUR MISSION: CUSTOMER'S SATISFACTION</h6>
                <h3 class="mt-2 mb-3">INNOVATION AND VALUE TO OUR CUSTOMERS</h3>
                <p>Digi Patch Solution is a highly respected embroidery digitizing company that is part of a large,
                    US-based
                    conglomerate. Our Services surpass the expectations of our Customers. Our objective is to bring the
                    best out of the best for our customers. We emphasize on the philosophy to build a long term business
                    relation with our customers. We value our customers and it is due to our valuable customers we
                    thrive for excellence.
                </p>

                <a href="about.html" class="btn button-style mt-sm-5 mt-4">Lets Talk</a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 right-img-w3ls pl-lg-4 mt-lg-2 mt-4">
                <div class="bott-w3ls mr-xl-5">
                    <h3 class="title-w3 text-bl mb-3 font-weight-bold">Digital Services Real Facts</h3>
                    <p class="title-sub-2 mb-3">Digital Services has built its reputation and developed its expertise
                        over the past few years through hardworking and learning process. We believe in learning and we
                        describe ourself as below. </p>
                </div>
                <div class="row mt-5">
