...
<!-- banner -->
<div class="banner_w3lspvt position-relative main">
    <div class="container">
        <div class="d-md-flex text-center">
            <div class="w3ls_banner_txt text-center">
                <h3 class="w3ls_pvt-title">EMBROIDERY <br><span>DIGITIZING</span> <br>VECTOR CONVERSION <span><br>CUSTOM
                        PATCHES</span>
                </h3>
                <p class="text-sty-banner text-center">Experience best Embroidery Digitizing and Vector Conversion
                    Services along
                    with great quality Custom Patches.</p>
                <a href="contact.php" class="btn button-style mt-md-5 ob">Order Now</a>
            </div>
                ...
                <div class="slider">
                    <div class="slides">
                        ...
                        <div class="slide first">
                            <img src="images/m1r.jpg" alt="banner image">
                        </div>
                        <div class="slide">
                            <img src="images/p2r.jpg" alt="">
                        </div>
                        <div class="slide">
                            <img src="images/m2r.jpg" alt="">
                        </div>
                        <div class="slide">
...
<section class="banner-bottom-w3layouts bg-li py-5" id="services">
    <div class="container py-xl-5 py-lg-3">
        ...
        <div class="row pt-lg-4">
            <ul class="feature-v7__grid">
                <li class="feature-v7__grid-item">
                    <div class="feature-v7__sub-grid cd-items-center">
                ...
                <li class="feature-v7__grid-item">
                    ...
                    <div style="font-family: poppins !important;" class="feature-v7__sub-grid">
                        ...
                        <p class="feature-v7__description">Get a free quote with the stitch count for your convenience.
                            Price estimates provided with fast turnaround time with ourexpert digitizers available for
                            help.</p>
                    </div>
                </li>
                ...
                <li class="feature-v7__grid-item">
                    ...
                    <div style="font-family: poppins !important;" class="feature-v7__sub-grid">
                        ...
                        <p class="feature-v7__description">We are offering our clients to pay their payment with most
                            popular and secure payment gateways which are integrated with our website for embroidery
                            digitizing & vector art services.</p>
                    </div>
                </li>
                ...
                <li class="feature-v7__grid-item">
                    ...
                    <div style="font-family: poppins !important;" class="feature-v7__sub-grid">
                        ...
                        <p class="feature-v7__description">Our excellent support is available to our customers 24/5
                            (Monday to Friday) You can call us or email us anytime for any inquiry regarding the status
                            of your orders.</p>
                    </div>
                </li>
            </ul>
                ...
                <main class="table bg-img">
                    <section style="font-family: poppins;" class="table__body">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="" class="ttd">1.5</td>
                                    <td data-label="10">110.18</td>
                                    ...
                                    <td data-label="100" class="offH">208.6</td>
                                    <td data-label="200" class="offH">266</td>
                                    <td data-label="300" class="offH">357</td>
                                    <td data-label="500" class="offH">525</td>
                                    <td data-label="1000" class="offH">700</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">2.0</td>
                                    ...
                                    <td data-label="300" class="offH">378</td>
                                    <td data-label="500" class="offH">560</td>
                                    <td data-label="1000" class="offH">770</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">2.5</td>
                                    ...
                                    <td data-label="300" class="offH">415.8</td>
                                    <td data-label="500" class="offH">595</td>
                                    <td data-label="1000" class="offH">840</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">3.0</td>
                                    ...
                                    <td data-label="300" class="offH">462</td>
                                    <td data-label="500" class="offH">630</td>
                                    <td data-label="1000" class="offH">952</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">3.5</td>
                                    ...
                                    <td data-label="300" class="offH">525</td>
                                    <td data-label="500" class="offH">770</td>
                                    <td data-label="1000" class="offH">1176</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">4.0</td>
                                    ...
                                    <td data-label="300" class="offH">609</td>
                                    <td data-label="500" class="offH">833</td>
                                    <td data-label="1000" class="offH">1400</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">4.5</td>
                                    ...
                                    <td data-label="300" class="offH">751.8</td>
                                    <td data-label="500" class="offH">1043</td>
                                    <td data-label="1000" class="offH">1792</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">5.0</td>
                                    ...
                                    <td data-label="300" class="offH">1083.6</td>
                                    <td data-label="500" class="offH">1358</td>
                                    <td data-label="1000" class="offH">2366</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">5.5</td>
                                    ...
                                    <td data-label="300" class="offH">1110</td>
                                    <td data-label="500" class="offH">1400</td>
                                    <td data-label="1000" class="offH">2400</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">6.0</td>
                                    ...
                                    <td data-label="300" class="offH">1140</td>
                                    <td data-label="500" class="offH">1450</td>
                                    <td data-label="1000" class="offH">2500</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">6.5</td>
                                    ...
                                    <td data-label="300" class="offH">1170</td>
                                    <td data-label="500" class="offH">1500</td>
                                    <td data-label="1000" class="offH">2550</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">7.0</td>
                                    ...
                                    <td data-label="300" class="offH">1185</td>
                                    <td data-label="500" class="offH">1550</td>
                                    <td data-label="1000" class="offH">2600</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">7.5</td>
                                    ...
                                    <td data-label="300" class="offH">1200</td>
                                    <td data-label="500" class="offH">1650</td>
                                    <td data-label="1000" class="offH">2700</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">8.0</td>
                                    ...
                                    <td data-label="300" class="offH">1220.4</td>
                                    <td data-label="500" class="offH">1750</td>
                                    <td data-label="1000" class="offH">2994</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">8.5</td>
                                    ...
                                    <td data-label="300" class="offH">1479.6</td>
                                    <td data-label="500" class="offH">2124</td>
                                    <td data-label="1000" class="offH">3654</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">9.0</td>
                                    ...
                                    <td data-label="300" class="offH">1591.2</td>
                                    <td data-label="500" class="offH">2256</td>
                                    <td data-label="1000" class="offH">4176</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">9.5</td>
                                    ...
                                    <td data-label="300" class="offH">1650.6</td>
                                    <td data-label="500" class="offH">2652</td>
                                    <td data-label="1000" class="offH">4494</td>
                                </tr>
                                <tr>
                                    <td data-label="" class="ttd">10.0</td>
                                    ...
                                    <td data-label="300" class="offH">1762.2</td>
                                    <td data-label="500" class="offH">2832</td>
                                    <td data-label="1000" class="offH">5094</td>
                                </tr>
                            </tbody>
                        </table>
                    </section>
    ...
    <div class="container py-xl-1 py-lg-1">
        <div class="row">
            <div class="col-lg-6 mob about-right-faq">
                ...
                <h3 class="text-da">CUSTOM PATCHES</h3>
                <p class="mt-4">We offer High Quality Custom Patches (Chenille Patches, Embroidered Patches,
                    PVC Patches,Woven Patches and Woven Tags) Lowest Prices Guaranteed</p>
                <ul class="w3l-right-book mt-4">
                    <li>Custom Embroidered Patches</li>
                    <li>Custom Chenille Patches</li>
            ...
            <div class="col-lg-6 left-wthree-img text-right">
                <a href="images/m1r.jpg" class="hov" data-lightbox="models" data-title="Caption1">
                    <h4 class="textHover ">Click To Enlarge </h4>
                    <img class="img-fluid ob   mt-3" style="border-radius: 2rem; " src="images/m1r.jpg" alt="">
            ...
            <div class="container2">
                <div class="gallery1">
                    ...
                    <a class="hov" href="images/p3r.jpg" data-lightbox="models" data-title="Caption2">
                        <h4 class="textHover1 ">Click To Enlarge </h4>
                        <img src="images/p3rs.jpg" alt="">
                    </a>
                    <a class="hov" href="images/p4r.jpg" data-lightbox="models" data-title="Caption3">
                        <h4 class="textHover1 ">Click To Enlarge </h4>
                        <img src="images/p4rs.jpg" alt="">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container py-xl-1 py-lg-1">
        <div class="row">
            <div class="col-lg-6  ">
                ...
                <a href="images/d1r.jpg" class="hov" data-lightbox="models" data-title="Caption1">
                    <h4 class="textHover ">Click To Enlarge </h4>
                    <img class="img-fluid  imob " src="images/d1r.jpg" alt="">
                </a>
            </div>
            <div class="col-lg-6 mob mt-4 about-right-faq">
                <h6>Business Consultancy</h6>
                <h3 class="text-da">DIGITIZING</h3>
                <p class="mt-4">Digi Patch Solutions is a firm that offers embroidery digitizing services. Our
                    professional
                    digitizers employ cutting-edge software and technology to convert digital photos into stitch files
                    that embroidery machines can interpret.</p>
                <ul class="w3l-right-book mt-4">
                    <li>Cap Digitizing</li>
                    <li>Flat Digitizing</li>
                    <li>Applique Digitizing</li>
...
<section class="midd-w3 py-1" id="faq">
    <div class="container py-xl-1 py-lg-1">
        <div class="row">
            <div class="col-lg-6 mob about-right-faq">
                <h6>Business Consultancy</h6>
                <h3 class="text-da">Rastor to Vector</h3>
                <p class="mt-4">We offer High Quality Custom Patches (Chenille Patches, Embroidered Patches,
                    PVC Patches,Woven Patches and Woven Tags) Lowest Prices Guaranteed</p>
                <ul class="w3l-right-book mt-4">
                    <li>Bitmap / Raster to Vector</li>
                    <!-- <li>Conversion use to reborn</li> -->
                    <li>Graphic Line art</li>
            ...
            <div class="col-lg-6 left-wthree-img text-right">
                ...
                <a href="images/r3r.jpg" class="hov" data-lightbox="models" data-title="Caption1">
                    <h4 class="textHover3 ">Click To Enlarge </h4>
                    <img class="img-fluid ob imob mt-3" src="images/r3r.jpg" alt="">
                </a>
            </div>
            <div class="container2">
                ...
                <div
                    ...
                    <footer class="ta0-flex ta0-flex-wrap ta0-items-center ta0-margin-top-auto@md">
                        ...
                        <cite class="ta0-text-sm">
                            ...
                            <span class="ta0-block ta0-color-contrast-medium ta0-margin-top-4xs">Designer at
                                CompanyX</span>
                        </cite>
                    </footer>
                </div>
                ...
                <div
                    ...
                    <footer class="ta0-flex ta0-flex-wrap ta0-items-center ta0-margin-top-auto@md">
                        ...
                        <cite class="ta0-text-sm">
                            ...
                            <span class="ta0-block ta0-color-contrast-medium ta0-margin-top-4xs">Developer at
                                CompanyY</span>
                        </cite>
                    </footer>
                </div>
                ...
                <div
                    ...
                    <footer class="ta0-flex ta0-flex-wrap ta0-items-center ta0-margin-top-auto@md">
                        ...
                        <cite class="ta0-text-sm">
                            ...
                            <span class="ta0-block ta0-color-contrast-medium ta0-margin-top-4xs">CEO at CompanyZ</span>
                        </cite>
                    </footer>
                </div>
            </div>
